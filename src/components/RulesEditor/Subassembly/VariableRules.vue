    ...
    >
      ...
      <n-form-item label="默认值" path="properties.defaultValue">
        ...
        <n-date-picker
          ...
          placeholder="请选择变量默认值"
          clearable
          v-else-if="nodeData.properties.valueType === 'datetime'"
        />
        <n-date-picker
          v-model:formatted-value="nodeData.properties.defaultValue"
          value-format="yyyy-MM-dd HH:mm:ss"
          ...
          placeholder="请选择变量默认值"
          clearable
          v-else-if="nodeData.properties.valueType === 'timestamp'"
        />
        <n-time-picker
          v-model:formatted-value="nodeData.properties.defaultValue"
...
<script lang="ts" setup>
  ...
  const handleValueType = (value: string) => {
    if (value === 'date') {
      nodeData.value.properties.defaultValue = format(new Date(), 'yyyy-MM-dd');
    } else if (value === 'time') {
