...
class CountdownView extends HtmlNode {
        ...
        <div class="node-body" style="padding-bottom: 0px;">
          <div class="node-content">
            <div class="line">
              ...
              <div class="value">${properties.timeValue} 秒</div>
            </div>
            <div class="line">
              <div class="label">执行频率</div>
              <div class="value">${properties.runTimeValue} 秒/次</div>
            </div>
          </div>
        </div>
      </div>
...
class CountdownModel extends HtmlNodeModel {
  setAttributes() {
    this.width = 240;
    this.height = 96;
