...
class TimerView extends HtmlNode {
        ...
        <div class="node-body" style="padding-bottom: 0px;">
          <div class="node-content">
            <div class="line" style="height: 38px; margin-bottom: 4px;">
              <div class="label">定时规则</div>
              <div class="values">${properties.cron || ''}</div>
            </div>
            <div class="line" style="height: 38px;">
              <div class="label">规则描述</div>
              <div class="values">${properties.description || ''}</div>
            </div>
          </div>
        </div>
      </div>
...
class TimerModel extends HtmlNodeModel {
  setAttributes() {
    this.width = 240;
    this.height = 132;
