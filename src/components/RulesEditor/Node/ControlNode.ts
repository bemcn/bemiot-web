...
class ControlView extends HtmlNode {
    ...
    const html = `
      <div class="nodeBox">
        <div class="node-head execute-head">
          <div class="tag execute-tag">${properties.label}</div>
        ...
        <div class="node-footer execute-footer">
          <div class="foot-line">
            <div class="label">控制值</div>
            <div class="value">${properties.outputValue || ''}</div>
          </div>
          <div class="foot-line">
            <div class="label">控制描述</div>
            <div class="value">${properties.description || ''}</div>
          </div>
        </div>
      </div>
    `;
...
class ControlModel extends HtmlNodeModel {
  setAttributes() {
    const properties = this.getProperties();
    this.width = properties.width || 240;
    this.height = properties.height || 176;
