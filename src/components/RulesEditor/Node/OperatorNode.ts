        ...
        <div class="node-body">
          <div class="node-content">
            <div class="line">
              ...
              <div class="value">${properties.principal || ''}</div>
            </div>
      `;
    if (
      properties.inputValue &&
      Array.isArray(properties.inputValue) &&
      properties.inputValue.length > 0
    ) {
      for (const item of properties.inputValue as any[]) {
        html += `
            <div class="line">
