...
class PopupView extends HtmlNode {
        ...
        <div class="node-body" style="padding-bottom: 0px;">
          <div class="node-content">
            <div class="line">
              ...
              <div class="value">${properties.templateName || ''}</div>
            </div>
            <div class="line">
              <div class="label">发送方式</div>
              <div class="value">${properties.sendType || ''}</div>
            </div>
    `;
...
class PopupModel extends HtmlNodeModel {
  setAttributes() {
    this.width = 240;
    this.height = 108;
