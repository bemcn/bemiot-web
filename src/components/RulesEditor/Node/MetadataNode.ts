...
class MetadataView extends HtmlNode {
  ...
  setHtml(rootEl: SVGForeignObjectElement) {
    ...
    el.className = 'node-wrapper metadata-wrapper';
    el.style.height = height + 'px'; // 设置DOM元素高度
    el.style.width = width + 'px';

    let timeFrame = '';
    let queryOut = '';
    switch (properties.timeFrame) {
      case 'min':
        timeFrame = '分钟范围查询';
        break;
      case 'hour':
    ...
    const html = `
      <div class="nodeBox">
        <div class="node-head metadata-head">
          <div class="tag metadata-tag">元数据</div>
        ...
        <div class="node-body">
          <div class="node-content">
            ...
            <div class="line">
              <div class="label">物模型</div>
              <div class="value">${properties.modelName || ''}</div>
            </div>
            <div class="line">
            ...
            <div class="line">
              <div class="label">查询输出</div>
              <div class="value">${queryOut}</div>
            </div>
          </div>
        </div>
...
class MetadataModel extends HtmlNodeModel {
  setAttributes() {
