...
class DateOperatorView extends HtmlNode {
  ...
  setHtml(rootEl: SVGForeignObjectElement) {
    ...
    let timeCompare = '';
    if (properties.timeCompare === '+') {
      timeCompare = '加';
    } else if (properties.timeCompare === '-') {
      timeCompare = '减';
    }
        ...
        <div class="node-body">
          <div class="node-content">
            <div class="line">
              ...
              <div class="value">${timeCompare}</div>
            </div>
            <div class="line">
              <div class="label">计算公式</div>
              <div class="value">
                <span style="color: #2080f0; margin-right: 5px;">${properties.timeCompare}</span>
                <span style="color: #666666; margin-right: 5px;">${properties.timeValue}</span>
                <span style="color: #333333;">${properties.timeUtil || ''}</span>
              </div>
            </div>
          </div>
        </div>
...
class DateOperatorModel extends HtmlNodeModel {
  setAttributes() {
    const properties = this.getProperties();
    this.width = properties.width || 270;
...
export default {
  type: 'DateOperatorNode',
  view: DateOperatorView,
  model: DateOperatorModel,
};
