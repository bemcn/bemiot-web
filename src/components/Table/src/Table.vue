<template>
  <div v-if="headShow" class="table-toolbar">
    <!--顶部左侧区域-->
    <div v-if="headTitleShow" class="flex items-center table-toolbar-left">
    ...
    <div v-if="headToolShow" class="flex items-center leading-none table-toolbar-right">
      <!--顶部右侧区域-->
...
<script lang="ts" setup>
  ...
  const headShow = props.headShow;
  const headTitleShow = props.headTitleShow;
  const headToolShow = props.headToolShow;
