    ...
    <n-grid :cols="24" :x-gap="24">
      <n-gi :span="12">
        ...
        <n-form-item label-style="color: #999999" label="设备编号：">
          <div class="item-value">{{ localParams?.deviceId || '' }}</div>
        </n-form-item>
        <n-form-item label-style="color: #999999" label="所属产品：">
          <div class="item-value">{{ localParams?.product?.productName || '' }}</div>
        </n-form-item>
        <n-form-item label-style="color: #999999" label="所属分组：">
          <div class="item-value">{{ localParams?.group?.groupName || '' }}</div>
        </n-form-item>
      ...
      <n-form-item-gi label-style="color: #999999" :span="12" label="固件版本：">
        <div class="item-value">{{
          localParams?.firmwareVersion === '' ? '无固件' : 'v' + localParams?.firmwareVersion
        }}</div>
      </n-form-item-gi>
      <n-form-item-gi
        label-style="color: #999999"
